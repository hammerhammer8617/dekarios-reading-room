...
import type { DurableThought, MysteryCasebook, ReadingPosition } from "@ss/shared";
...
function Casebook({ casebook }: { casebook: MysteryCasebook }) {
...
function RelationMap({ casebook }: { casebook: MysteryCasebook }) {
