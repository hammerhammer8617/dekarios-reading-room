...
export function DiaryPreview(props: {
  ...
  return (
    <div className="sheet-backdrop" role="presentation" onClick={props.onClose}>
      <section className="bottom-sheet diary-sheet" role="dialog" aria-label="书房日记素材" onClick={(e) => e.stopPropagation()}>
        ...
        <button className="action-primary wide-button" onClick={props.onWrite}>请盖尔写成书房日记</button>
