...
describe("CompanionDock", () => {
  ...
  it("supports jump, collapse, empty/error states, and clear recent", () => {
    ...
    expect(screen.getByRole("button", { name: "盖尔陪读" })).toBeInTheDocument();
    fireEvent.click(screen.getByRole("button", { name: "盖尔陪读" }));
    ...
    expect(screen.getByText("盖尔还没留下短评。")).toBeInTheDocument();
