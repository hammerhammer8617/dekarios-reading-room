...
export const OLDEST_BOOKSHELF_TOOL_NAME = "open_bookshelf_v2";
export const LEGACY_BOOKSHELF_TOOL_NAME = "open_bookshelf";
export const BOOKSHELF_RESOURCE_VERSION = "bookshelf-static-v4";
...
export const PREVIOUS_BOOKSHELF_RESOURCE_URI =
  "ui://ss-reading-nest/bookshelf-static-v3.html" as const;
export const OLDEST_BOOKSHELF_RESOURCE_URI =
