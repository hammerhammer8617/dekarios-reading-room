...
const caseItemStatusSchema = z.enum(["suspected", "confirmed", "disproved", "unknown"]);
const casePositionSchema = readingPositionSchema.optional();
      ...
      .array(
        z
          .object({
            ...
            firstSeenPosition: casePositionSchema,
            status: caseItemStatusSchema.optional().default("unknown")
          })
          .strict()
      )
      .max(30)
      ...
      .array(
        z
          .object({
            ...
            status: caseItemStatusSchema.optional().default("suspected"),
