...
describe("registerReadingResource", () => {
  it("uses the mobile bookshelf resource with standard and ChatGPT legacy CSP access to the deployed Worker origin", async () => {
    ...
    expect(READING_NEST_URI).toBe("ui://dekarios-reading-room/bookshelf-v1.html");
    expect(uri).toBe("ui://dekarios-reading-room/bookshelf-v1.html");
    ...
    expect(loaded.contents[0].uri).toBe("ui://dekarios-reading-room/bookshelf-v1.html");
