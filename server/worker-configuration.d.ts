/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 215b73c118f5c3f0087dfc0da2e6171a)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BUILD_SHA" | "MCP_PATH_TOKEN">> {}
}
declare module "*.html" {
	const value: string;
